...
BEGIN
    ...
    -- Insert sample cars
    INSERT INTO cars (client_id, make, model, year, registration_number, mileage, purchase_price, asking_price, purchase_date, owner_name, status, sold_price, sold_date, profit, repair_costs, dealer_commission, buyer_name, buyer_cnic, buyer_contact)
    VALUES 
    (client1_id, 'Toyota', 'Corolla', 2020, 'LZH-238', 45000, 2500000, 2800000, '2024-01-10', 'Ahmed Ali', 'sold', 2750000, '2024-01-18', 175000, 25000, 50000, 'Fahad Sheikh', '42101-9876543-2', '+92-333-5555555'),
    (client1_id, 'Honda', 'Civic', 2019, 'KHI-456', 62000, 3000000, 3400000, '2024-01-12', 'Sara Khan', 'available', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL),
    (client2_id, 'Suzuki', 'Alto', 2021, 'ISB-789', 28000, 1800000, 2100000, '2024-01-15', 'Muhammad Hassan', 'sold', 2050000, '2024-01-20', 205000, 15000, 30000, 'Ayesha Malik', '42101-1111111-3', '+92-345-7777777'),
    (client3_id, 'Toyota', 'Camry', 2021, 'LHR-321', 35000, 4500000, 4900000, '2024-01-20', 'Ali Ahmed', 'available', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL);
    ...
    INSERT INTO car_conditions (car_id, trunk_painted, hood_painted, roof_painted, front_left_door_painted, front_right_door_painted, back_left_door_painted, back_right_door_painted, front_left_fender_painted, front_right_fender_painted, back_left_fender_painted, back_right_fender_painted, grade)
    VALUES 
    (car1_id, TRUE, TRUE, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, 3),
    (car2_id, FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, FALSE, 4),
    (car3_id, FALSE, TRUE, FALSE, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, FALSE, FALSE, 4);
    
    -- Insert sample debts
    INSERT INTO debts (client_id, debtor_type, debtor_id, amount, debt_type, description, is_settled)
    VALUES 
    (client1_id, 'dealer', dealer1_id, 25000, 'owed_to_client', 'Pending commission payment for Toyota Corolla', false),
    (client2_id, 'buyer', buyer2_id, 100000, 'owed_by_client', 'Advance payment for next purchase', false),
    (client1_id, 'dealer', dealer1_id, 15000, 'owed_by_client', 'Advance commission paid', true);
