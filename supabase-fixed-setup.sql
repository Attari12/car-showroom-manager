...
-- Note: Keep clients table if it exists with data
...
BEGIN
    ...
    (car1_id, test_client_id, 'Toyota', 'Corolla GLi', 2020, 'Original Owner', 'LEA-1234', 'Pearl White', 'Excellent', 45000, 3200000, 3500000, '2023-01-15', 'available', 'Well maintained family car with complete service history.', dealer1_id, NULL, 100000, seller1_id, 2000000, 'partially_owned', 'flat', 0, 0),
    (car2_id, test_client_id, 'Honda', 'Civic Oriel', 2019, 'Company Vehicle', 'LEB-5678', 'Silver Metallic', 'Good', 52000, 2800000, 3100000, '2023-02-20', 'sold', 'Clean corporate car with minor wear and tear.', dealer2_id, buyer1_id, 150000, seller2_id, 0, 'fully_investor_owned', 'percentage', 0, 15),
    (car3_id, test_client_id, 'Suzuki', 'Alto VXR', 2021, 'Lady Driven', 'LEC-9012', 'Candy Red', 'Excellent', 28000, 1800000, 2000000, '2023-03-10', 'available', 'Brand new condition with remaining warranty.', NULL, NULL, NULL, NULL, 1800000, 'partially_owned', 'flat', 0, 0),
    (car4_id, sigma_client_id, 'BMW', 'X3 xDrive30i', 2018, 'Import Direct', 'LED-3456', 'Jet Black', 'Good', 68000, 7500000, 8200000, '2023-04-05', 'reserved', 'Luxury SUV with premium features.', dealer3_id, NULL, 300000, NULL, 4000000, 'partially_owned', 'flat', 0, 0),
    (car5_id, sigma_client_id, 'Mercedes-Benz', 'C200 AMG Line', 2019, 'Lease Return', 'LEE-7890', 'Brilliant Blue', 'Excellent', 42000, 6200000, 6800000, '2023-04-15', 'sold', 'Executive sedan in pristine condition.', dealer3_id, buyer4_id, 250000, NULL, 3000000, 'partially_owned', 'flat', 0, 0);
    ...
    INSERT INTO cars (client_id, make, model, year, owner_name, registration_number, color, condition, mileage, purchase_price, asking_price, purchase_date, status, description, dealer_id, showroom_investment, ownership_type) VALUES
    (test_client_id, 'Toyota', 'Camry Grande', 2017, 'Bank Auction', 'LEB-2468', 'Champagne Gold', 'Good', 89000, 4200000, 4600000, '2023-05-01', 'available', 'Mid-size luxury sedan with leather interior.', dealer1_id, 4200000, 'partially_owned'),
    (test_client_id, 'Honda', 'City Aspire', 2018, 'Doctor Owner', 'LEC-1357', 'Taffeta White', 'Excellent', 71000, 2400000, 2750000, '2023-05-10', 'available', 'Well-maintained sedan with genuine parts only.', NULL, 2400000, 'partially_owned'),
    (test_client_id, 'Suzuki', 'Cultus VXL', 2020, 'Expat Owned', 'LEA-9753', 'Graphite Grey', 'Excellent', 35000, 1650000, 1850000, '2023-05-15', 'pending', 'Low mileage hatchback.', dealer2_id, 1000000, 'partially_owned'),
    (sigma_client_id, 'Audi', 'A4 TFSI', 2017, 'Businessman', 'LED-8642', 'Glacier White', 'Good', 95000, 5800000, 6300000, '2023-05-20', 'available', 'German engineering with quattro AWD.', dealer3_id, 3500000, 'partially_owned'),
    (sigma_client_id, 'Toyota', 'Land Cruiser VX', 2016, 'Embassy Vehicle', 'LEE-1975', 'Desert Beige', 'Good', 125000, 12500000, 13800000, '2023-05-25', 'available', 'Bulletproof SUV with premium features.', NULL, 12500000, 'partially_owned');
