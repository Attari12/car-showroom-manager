-- ==========================================
-- ENHANCED CAR MANAGEMENT SYSTEM WITH INVESTORS & SELLERS
-- ==========================================
...
CREATE TABLE IF NOT EXISTS car_investments (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS profit_distributions (
    ...
    distribution_data JSONB, -- Store detailed breakdown
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
BEGIN
    ...
    INSERT INTO cars (id, client_id, make, model, year, owner_name, registration_number, color, mileage, purchase_price, asking_price, purchase_date, status, condition, description, dealer_id, buyer_id, dealer_commission, seller_id, showroom_investment, ownership_type, commission_type, commission_amount, commission_percentage) VALUES
    (uuid_generate_v4(), test_client_id, 'Toyota', 'Corolla GLi', 2020, 'Original Owner', 'LEA-1234', 'Pearl White', 45000, 3200000, 3500000, '2023-01-15', 'available', 'Excellent', 'Well maintained family car with complete service history. Non-accidental, first owner, all documents clear.', dealer1_id, NULL, 100000, seller1_id, 2000000, 'partially_owned', 'flat', 0, 0),
    (uuid_generate_v4(), test_client_id, 'Honda', 'Civic Oriel', 2019, 'Company Vehicle', 'LEB-5678', 'Silver Metallic', 52000, 2800000, 3100000, '2023-02-20', 'sold', 'Good', 'Clean corporate car with minor wear and tear. Regular maintenance done.', dealer2_id, buyer1_id, 150000, seller2_id, 0, 'fully_investor_owned', 'percentage', 0, 15),
    (uuid_generate_v4(), test_client_id, 'Suzuki', 'Alto VXR', 2021, 'Lady Driven', 'LEC-9012', 'Candy Red', 28000, 1800000, 2000000, '2023-03-10', 'available', 'Excellent', 'Brand new condition with remaining warranty. Perfect for city driving.', NULL, NULL, NULL, NULL, 1800000, 'partially_owned', 'flat', 0, 0),
    (uuid_generate_v4(), sigma_client_id, 'BMW', 'X3 xDrive30i', 2018, 'Import Direct', 'LED-3456', 'Jet Black', 68000, 7500000, 8200000, '2023-04-05', 'reserved', 'Good', 'Luxury SUV with premium features. Imported from Japan with complete auction sheet.', dealer3_id, NULL, 300000, NULL, 4000000, 'partially_owned', 'flat', 0, 0),
    (uuid_generate_v4(), sigma_client_id, 'Mercedes-Benz', 'C200 AMG Line', 2019, 'Lease Return', 'LEE-7890', 'Brilliant Blue', 42000, 6200000, 6800000, '2023-04-15', 'sold', 'Excellent', 'Executive sedan in pristine condition. Full service history available.', dealer3_id, buyer4_id, 250000, NULL, 3000000, 'partially_owned', 'flat', 0, 0)
    ...
    (car2_id, investor2_id, 2800000, 100, false), -- Fully investor owned
    (car1_id, investor2_id, 800000, 25, true) -- Second investor in first car
    ON CONFLICT DO NOTHING;
    
    -- Add more cars for better inventory display
    INSERT INTO cars (client_id, make, model, year, owner_name, registration_number, color, mileage, purchase_price, asking_price, purchase_date, status, condition, description, dealer_id, buyer_id, dealer_commission, showroom_investment, ownership_type) VALUES
    (test_client_id, 'Toyota', 'Camry Grande', 2017, 'Bank Auction', 'LEB-2468', 'Champagne Gold', 89000, 4200000, 4600000, '2023-05-01', 'available', 'Good', 'Mid-size luxury sedan with leather interior. Needs minor touch-up.', dealer1_id, NULL, 120000, 4200000, 'partially_owned'),
    (test_client_id, 'Honda', 'City Aspire', 2018, 'Doctor Owner', 'LEC-1357', 'Taffeta White', 71000, 2400000, 2750000, '2023-05-10', 'available', 'Excellent', 'Well-maintained sedan with genuine parts only. Complete record available.', NULL, NULL, NULL, 2400000, 'partially_owned'),
    (test_client_id, 'Suzuki', 'Cultus VXL', 2020, 'Expat Owned', 'LEA-9753', 'Graphite Grey', 35000, 1650000, 1850000, '2023-05-15', 'pending', 'Excellent', 'Low mileage hatchback. Expat leaving country sale.', dealer2_id, NULL, 80000, 1000000, 'partially_owned'),
    (sigma_client_id, 'Audi', 'A4 TFSI', 2017, 'Businessman', 'LED-8642', 'Glacier White', 95000, 5800000, 6300000, '2023-05-20', 'available', 'Good', 'German engineering with quattro AWD. Premium interior with sunroof.', dealer3_id, NULL, 200000, 3500000, 'partially_owned'),
    (sigma_client_id, 'Toyota', 'Land Cruiser VX', 2016, 'Embassy Vehicle', 'LEE-1975', 'Desert Beige', 125000, 12500000, 13800000, '2023-05-25', 'available', 'Good', 'Bulletproof SUV with premium features. Diplomatic use with maintenance records.', NULL, NULL, NULL, 12500000, 'partially_owned')
    ON CONFLICT DO NOTHING;
...
BEGIN
    RAISE NOTICE '============================================';
    RAISE NOTICE 'ENHANCED CAR MANAGEMENT SYSTEM SETUP COMPLETED!';
    RAISE NOTICE '============================================';
    RAISE NOTICE 'Created tables: clients, cars, dealers, buyers, investors, sellers';
    RAISE NOTICE 'Investment tracking: car_investments, profit_distributions';
    ...
    RAISE NOTICE 'Your enhanced car management system is ready to use!';
    RAISE NOTICE '============================================';
END $$;
